...
const HELP: Record<Source, { title: string; items: string[] }> = {
  zernio: {
    ...
    items: [
      "La página se vincula en el panel de Zernio, no desde Parley. Copia de ahí el accountId de la cuenta de Facebook conectada.",
      "La API key se crea en Zernio → Settings → API Keys y se muestra una sola vez (empieza con sk_).",
      "El mismo webhook de Zernio entrega Instagram, WhatsApp y X si esas cuentas están conectadas; Parley filtra por plataforma y solo ingiere lo de Facebook aquí.",
